...
def find_mean_std(TOTAL_NUMBER_OF_IMAGES, 
    ...
    if NUMPY_DOUBLE_CHECK:
        ...
        return RGB_mean, RGB_std, None, None, None, None, None, None
...
RGB_mean, RGB_std, RGB_mean_np, RGB_std_np, X_mean_bar_all_ch, X_std_bar_all_ch,  Total_mean_np, Total_std_np = find_mean_std(TOTAL_NUMBER_OF_IMAGES, 
